...
@shared_task
def autonomous_ingestion_campaign_task(batch_id: int):
    try:
        ...
        return _run_campaign_cycle(batch, trigger="scheduled")
    except Exception as exc:
        return {"ok": False, "message": f"Campaign task failed: {exc}"}
