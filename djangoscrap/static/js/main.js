...
(function() {
  ...
  if (preloader) {
    ...
    // If a resource never finishes (hung image/video), `load` may never fire — still unblock the UI.
  ...
  document.querySelectorAll('.isotope-layout').forEach(function(isotopeItem) {
    ...
    if (!isoContainer || typeof imagesLoaded !== 'function' || typeof Isotope !== 'function') return;
